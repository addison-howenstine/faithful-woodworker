import type { SiteConfig, HomeContent, AboutContent, PortfolioContent, OrderContent, InstagramContent } from '@/types'
...
export const instagram = instagramData as InstagramContent
